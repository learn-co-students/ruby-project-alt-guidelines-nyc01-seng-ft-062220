...
club1 = Club.create(name_of_club: "Film Club", about_club: "Watch films", current_size: 10, member_capacity: 15, meetings_day: "Friday", attendance: 7)
club2 = Club.create(name_of_club: "New York, New York", about_club: "Only New York movies", current_size: 4, member_capacity: 7, meetings_day: "Monday", attendance: 3)
club3 = Club.create(name_of_club: "At capacity", about_club: "old movies", current_size: 7, member_capacity: 7, meetings_day: "Tuesday", attendance: 7)
club4 = Club.create(name_of_club: "Music Movies Only!", about_club: "Only music movies docs and biopics", current_size: 4, member_capacity: 7, meetings_day: "Monday", attendance: 3)
